package com.congthanh.inventoryservice.cqrs.command.aggregate;

import com.congthanh.inventoryservice.cqrs.command.command.ReleaseInventoryCommand;
import com.congthanh.inventoryservice.cqrs.command.command.ReserveInventoryCommand;
import com.congthanh.inventoryservice.cqrs.command.event.InventoryReservationFailedEvent;
import com.congthanh.inventoryservice.cqrs.command.event.InventoryReservedEvent;
